...
public class EmployeeDashboard extends javax.swing.JFrame {
    ...
    public EmployeeDashboard() {
        ...
        EmployeeDashboard.this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                if (choose == JOptionPane.YES_OPTION) {
                    ...
                    String systemExitActivityLog = "INSERT INTO log(usr_id, usr_type, usr_username, log_activity, log_description, log_state) VALUES ((SELECT usr_id FROM user WHERE usr_username = '" + lblEmployeeUsername.getText() + "'),'Employee','" + lblEmployeeUsername.getText() + "','Employee System Exit', '" + lblEmployeeUsername.getText() + " system exited' ,'SUCCESS')";
                    try {
        ...
        ActionListener actionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (now >= 6 && now < 12) {
                    loginWish.setText("Good morning " + lblEmployeeUsername.getText());
                } else if (now >= 12 && now < 17) {
                    loginWish.setText("Good afternoon " + lblEmployeeUsername.getText());
                } else if (now >= 17 && now < 20) {
                    loginWish.setText("Good evening " + lblEmployeeUsername.getText());
                } else {
                    loginWish.setText("Good night " + lblEmployeeUsername.getText());
                }
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/frames/img/icons8_buying_75px.png"))); // NOI18N
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ...
        EmployeeEmp ed = new EmployeeEmp();
        EmployeeEmp.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        ed.setVisible(true);
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeeStock em = new EmployeeStock();
        EmployeeStock.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    }//GEN-LAST:event_jPanel3MouseClicked

    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeePOS em = new EmployeePOS();
        EmployeePOS.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        EmployeeSales.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    }//GEN-LAST:event_jPanel4MouseClicked

    private void jPanel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel10MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeeEmpPayroll em = new EmployeeEmpPayroll();
        EmployeeEmpPayroll.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeeEmpAttendance em = new EmployeeEmpAttendance();
        EmployeeEmpAttendance.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    }//GEN-LAST:event_jPanel9MouseClicked

    private void jPanel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel13MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeeLogs em = new EmployeeLogs();
        EmployeeLogs.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
    }//GEN-LAST:event_jPanel13MouseClicked

    private void jPanel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel14MouseClicked
        EmployeeDashboard.this.dispose();
        EmployeeSettings em = new EmployeeSettings();
        EmployeeSettings.lblEmployeeUsername.setText(lblEmployeeUsername.getText());
        em.setVisible(true);
